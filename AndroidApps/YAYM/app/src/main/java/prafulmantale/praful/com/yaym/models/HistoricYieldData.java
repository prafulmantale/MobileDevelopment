...
public class HistoricYieldData {
    ...
    public static HistoricYieldData fromJSON(JSONObject jsonObject, String instrument){
    ...
    public static List<HistoricYieldData> fromJSON(JSONArray jsonArray, String instrument){
        ...
        for(int i = 0; i < len; i ++){
            ...
            HistoricYieldData data = fromJSON(jsonObject, instrument);
