...
public class DynamicListView extends ListView {
    ...
    private AdapterView.OnItemLongClickListener mOnItemLongClickListener =
            new AdapterView.OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    mMobileItemId = getAdapter().getItemId(pos);
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        ToDoItemAdapter adapter = ((ToDoItemAdapter)getAdapter());
...
//                System.out.println("onTouchEvent:" + deltaY);
...
//        System.out.println("isBelow:" + isBelow);
//        System.out.println("isAbove:" + isAbove);
//        System.out.println("mDownY:" + mDownY);
//        System.out.println("mLastEventY:" + mLastEventY);
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(toDoItems, originalItem, getPositionForView(switchView));
...
//        System.out.println("touchEventsEnded");
    ...
    public void setCheeseList(ArrayList<ToDoItem> cheeseList) {
        toDoItems = cheeseList;
    }
