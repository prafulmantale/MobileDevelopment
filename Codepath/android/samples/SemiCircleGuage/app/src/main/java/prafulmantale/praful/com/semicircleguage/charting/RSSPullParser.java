...
public class RSSPullParser extends DefaultHandler {
     ...
     * @throws org.xmlpull.v1.XmlPullParserException defined by XMLPullParser; thrown if the thread is cancelled.
     * @throws java.io.IOException thrown if an IO error occurs during parsing
     */
