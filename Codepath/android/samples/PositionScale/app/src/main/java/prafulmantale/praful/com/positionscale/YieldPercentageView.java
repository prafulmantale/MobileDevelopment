...
public class YieldPercentageView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(outerRect, needlePaint);
        canvas.drawCircle(width/2, height/2, (float)outerRect.height()/3, outerCirclePaintBlank);
        canvas.drawCircle(width/2, height/2, (float)outerRect.height()/4, innerCirclePaint);
//        canvas.drawArc(innerRect, 135, 270, true, innerCirclePaint);
